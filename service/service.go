...
type Authorization interface {
	...
	GenerateRefreshToken(user models.SingIn) (string, error)
...
type Investitions interface {
	CreateInvestition(investition models.Investition) (int, error)
}
...
func NewService(repos *repository.Repository) *Service {
	return &Service{
		...
		Investitions: NewInvestitionsService(repos.Investitions),
	}
}